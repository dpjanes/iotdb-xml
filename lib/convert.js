...
/**
 */
const convert_raw = _.promise((self, done) => {
    xml2js.parseString(self.document, (error, result) => {
        if (error) {
            done(error)
        } else if (!result) {
...
convert_raw.method = "convert.raw"
convert_raw.description = ``
convert_raw.requires = {
    document: [ _.is.String, _.is.Buffer, ]
}
convert_raw.accepts = {
}
convert_raw.produces = {
    json: _.is.JSON,
}
convert_raw.params = {
    document: _.p.normal,
}
convert_raw.p = _.p(convert_raw)

/**
 *  API
 */
exports.convert = convert
exports.convert.raw = convert_raw
